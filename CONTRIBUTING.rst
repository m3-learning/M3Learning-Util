...
Welcome to ``M3Learning-Util`` contributor's guide.
...
If you experience bugs or general issues with ``M3Learning-Util``, please have a look
...
You can help improve ``M3Learning-Util`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``M3Learning-Util`` documentation uses Sphinx_ as its main documentation compiler.
...
that any documentation update is done in the same way was a code contribution.
   ...
   .. tip::
      ...
      propose changes in ``M3Learning-Util``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n M3Learning-Util python=3 six virtualenv pytest pytest-cov
    conda activate M3Learning-Util
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/M3Learning-Util.git
    cd M3Learning-Util
